...
$amount = $_POST["amount"];
$fromRate = str_replace(",", "", $data->$from);
$toRate = str_replace(",", "", $data->$to);
...
<body>
    ...
    <main class=" max-w-[1000px] mx-auto p-10">
        ...
        <form action="calculate.php" method="post" class=" p-4 bg-gray-200 rounded-lg border border-gray-200 ">
            <h2 class=" text-center font-bold text-xl mb-10">Calculate Result</h2>
            ...
            <div class=" py-10 flex justify-between">
                <div class=" flex-grow w-full">
                    <h2 class=" font-bold">Your Amount</h2>
                    <h3 class=" font-bold font-mono text-2xl min-h-[150px] ">
                        <?= $amount . " " . $from  ?>
                ...
                <div class=" flex-grow w-full">
                    ...
                    <div class=" min-w-[150px] bg-green-200  rounded-lg ">
                        <?= $result . " " . $to ?>
            ...
            <div class=" flex justify-center gap-5">
                <a href="./index.php" class=" w-full justify-center flex-grow py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                    Calculate again
                </a>
