...
<body>
    ...
    <main class=" max-w-[1000px] mx-auto p-10">
        ...
        <div class=" border border-gray-400 p-5 ">
            <div>
                <h1 class="rounded-lg font-bold text-3xl text-center ">Record History</h1>
            </div>
            <?php
            ...
            ?>
                ...
                <p class=" bg-gray-200 rounded-lg my-2 px-2">
                    <?= "($count.)  $text " ?>
                </p>
